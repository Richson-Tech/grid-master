        ...
        <motion.div className="absolute inset-0 z-[30] flex min-h-screen w-full items-center justify-center mobile:px-6">
          ...
          >
            ...
            <div className="flex flex-col gap-12">
              ...
              <button
                className="bg-yellow-500 rounded-[2rem] border-[3px] border-black p-8 text-[2.4rem] font-bold uppercase shadow-black-sh transition-all duration-300 hover:shadow-purple-sh mobile:p-6 mobile:text-[1.8rem]"
                onClick={handleRestart}
              >
                Restart
              </button>
              <button
                className="bg-red-500 rounded-[2rem] border-[3px] border-black p-8 text-[2.4rem] font-bold uppercase shadow-black-sh transition-all duration-300 hover:shadow-purple-sh mobile:p-6 mobile:text-[1.8rem]"
                onClick={quitGame}
              >
                Quit Game
              </button>
